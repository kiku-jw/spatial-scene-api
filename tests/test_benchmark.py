...
class BenchmarkTests(unittest.TestCase):
    ...
    def test_build_render_plan_creates_each_preset_for_each_input(self) -> None:
        ...
        self.assertEqual(plan[-1].output_path, Path("outputs/benchmark/product/vertical_float.mp4"))
        ...
        items = [
            BenchmarkItem(
                ...
                outputs={
                    ...
                    "drift": Path("outputs/benchmark/portrait/drift.mp4"),
                    "push_pull": Path("outputs/benchmark/portrait/push_pull.mp4"),
                    "vertical_float": Path("outputs/benchmark/portrait/vertical_float.mp4"),
                },
            )
        ]
